...
const FDFunc = ({asyncValidating, handleSubmit, submitAction,  pristine, submitting, reset}) => (
    
<form onSubmit={handleSubmit((fields) => save(fields, submitAction, reset))} id='form1' className='mLabForm'>
    <div className='form-row'>Payment/Transfer</div>    
...
const FDFuncForm = reduxForm({
    form: 'contact',
})(FDFunc);

export default FDFuncForm;